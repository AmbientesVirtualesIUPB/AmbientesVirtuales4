...
public class PersonalizarFurtivo : MonoBehaviour
{
    ...
    public void CambiarMeshLlanta()
    {
        ...
        llantaMeshFilterDDer.mesh = llantaMeshesDelanteraDerecha[llantaIndex].sharedMesh; // Asignamos a las llantas el proximo mesh en el array
        llantaRendererDDer.material = llantaMaterials[llantaIndex]; // Asignamos a las llantas el proximo material en el array

        // Llanta Trasera
        llantaMeshFilterTrasera.mesh = llantaMeshesTrasera[llantaIndex].sharedMesh; // Asignamos a las llantas el proximo mesh en el array
        llantaRendererTrasera.material = llantaMaterials[llantaIndex]; // Asignamos a las llantas el proximo material en el array
    ...
    public void PasarInfoBD()
    {
        for (int i = 0; i < indiceGlobal.Length; i++)
        {
            managerBD.datos[i + 15] = indiceGlobal[i];
        }
